...
const CAPABILITY_WORLDS = [
  {
    ...
    metrics: [
      ...
      { label: 'ACCURACY', value: '99.2%', desc: 'Deterministic Reasoning SLA' },
      { label: 'TOPOLOGY', value: 'Hybrid DAG', desc: 'Distributed Pipeline' },
    ],
  },
  {
    code: '02',
    ...
    metrics: [
      ...
      { label: 'AVAILABILITY', value: '99.95%', desc: 'Multi-Region SLA' },
      { label: 'SECURITY', value: 'AES-256-GCM', desc: 'Zero-Trust Enclaves' },
    ],
  },
  {
    code: '03',
    ...
    metrics: [
      { label: 'EFFICIENCY', value: '4.8x', desc: 'Workflow Acceleration' },
      { label: 'ORCHESTRATION', value: 'Event Mesh', desc: 'Supervised Agents' },
      { label: 'RELIABILITY', value: '99.8%', desc: 'Automated Recovery' },
    ],
  },
  {
    code: '04',
    ...
    metrics: [
      ...
      { label: 'PERFORMANCE', value: '98/100', desc: 'Lighthouse Core Score' },
      { label: 'RESPONSE', value: '< 50ms', desc: 'Input Latency Benchmark' },
    ],
  },
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <div className="relative max-w-3xl mx-auto flex flex-col items-center justify-center space-y-3.5 sm:space-y-4">
              {/* Refined Luxury Tagline */}
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-heading font-black tracking-[-0.03em] leading-[1.12] text-white select-none">
                ...
                <br />
                <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-electric-cyan via-white to-electric-cyan drop-shadow-[0_0_35px_rgba(0,212,255,0.85)] animate-pulse">
                  WE BUILD IT.
                </span>
              </h1>

              {/* High-Tech System Description with Balanced Whitespace */}
              <p className="max-w-lg mx-auto text-xs sm:text-sm font-sans text-white/80 leading-relaxed font-light drop-shadow-[0_2px_15px_rgba(0,0,0,0.9)]">
              ...
              {/* Holographic CTAs */}
              <div className="pt-1 flex flex-wrap items-center justify-center gap-2.5 sm:gap-4">
                <PageTransitionLink
                  href="/contact"
                  cursor="explore"
                  className="group relative inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-electric-cyan text-background font-mono font-bold text-xs tracking-wider transition-all duration-300 hover:scale-105 shadow-[0_0_25px_rgba(0,212,255,0.6)] hover:shadow-[0_0_40px_rgba(0,212,255,0.9)]"
                >
                ...
                <button
                  ...
                  data-cursor="explore"
                  className="group inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full border border-white/20 hover:border-electric-cyan bg-[#020b18]/80 backdrop-blur-xl text-white font-mono font-medium text-xs tracking-wider hover:text-electric-cyan transition-all duration-300 hover:bg-[#020b18] shadow-[0_0_20px_rgba(0,0,0,0.5)]"
                >
                  <span>EXPLORE DISCIPLINES</span>
                  <ArrowDownRight className="w-3.5 h-3.5 text-electric-cyan transition-transform duration-300 group-hover:translate-y-0.5" />
                </button>
              </div>

              {/* Clean 4-Discipline Indicator Strip */}
              <div className="pt-3 border-t border-white/10 max-w-2xl w-full grid grid-cols-2 md:grid-cols-4 gap-2 text-[9px] sm:text-[10px] font-mono tracking-wider text-white/70 uppercase">
                <div className="p-2 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md flex flex-col items-center gap-0.5 group hover:border-electric-cyan/40 transition-colors">
                  ...
                  <span className="text-[8px] text-white/40">Neural Decision Core</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md flex flex-col items-center gap-0.5 group hover:border-electric-cyan/40 transition-colors">
                  <div className="flex items-center gap-1 text-electric-cyan font-bold">
                    <span className="w-1.5 h-1.5 rounded-full bg-electric-cyan" />
                  ...
                  <span className="text-[8px] text-white/40">Distributed Mesh</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md flex flex-col items-center gap-0.5 group hover:border-electric-cyan/40 transition-colors">
                  <div className="flex items-center gap-1 text-electric-cyan font-bold">
                    <span className="w-1.5 h-1.5 rounded-full bg-electric-cyan" />
                  ...
                  <span className="text-[8px] text-white/40">Autonomous Agent Mesh</span>
                </div>
                <div className="p-2 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md flex flex-col items-center gap-0.5 group hover:border-electric-cyan/40 transition-colors">
                  <div className="flex items-center gap-1 text-electric-cyan font-bold">
                    <span className="w-1.5 h-1.5 rounded-full bg-electric-cyan" />
                  ...
                  <span className="text-[8px] text-white/40">Spatial 2.5D Flagship</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="relative max-w-4xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-white/[0.03] border border-white/10 text-[9px] sm:text-[10px] font-mono tracking-[0.3em] text-white/60 uppercase">
                <span>01 // ARCHITECTURAL THESIS</span>
              </div>

              <h2 className="text-2xl sm:text-4xl md:text-5xl font-heading font-black tracking-tight leading-[1.08] text-white drop-shadow-[0_4px_35px_rgba(0,0,0,0.9)]">
                WE ENGINEER <br />
                SYSTEMS THAT <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-electric-cyan via-white to-electric-cyan drop-shadow-[0_0_35px_rgba(0,212,255,0.7)]">
                  MOVE BUSINESS FORWARD.
                </span>
              </h2>

              <p className="max-w-md mx-auto text-xs font-mono text-white/60 tracking-widest uppercase">
                SCROLL TO TRAVERSE THE FOUR ARASS CORE DISCIPLINES ↓
              </p>

              {/* Holographic Circuit Pillar Blueprint */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 max-w-3xl mx-auto pt-3 text-left font-mono">
                {CAPABILITY_WORLDS.map((cap) => (
                  ...
                  >
                    ...
                    <div className="text-[9px] text-white/50 leading-relaxed font-sans line-clamp-2">
                      {cap.statement}
                    </div>
                  </div>
                ))}
          ...
          >
            <div className="relative max-w-4xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-electric-cyan/10 border border-electric-cyan/30 text-[9px] sm:text-[10px] font-mono tracking-[0.25em] text-electric-cyan uppercase">
                <Cpu className="w-3 h-3" />
                <span>{CAPABILITY_WORLDS[0].discipline}</span>
              </div>

              <h2 className="text-2xl sm:text-4xl md:text-5xl font-heading font-black tracking-tight text-white leading-tight drop-shadow-[0_4px_35px_rgba(0,0,0,0.9)]">
                {CAPABILITY_WORLDS[0].title}
              </h2>

              <p className="text-xs sm:text-sm md:text-base font-mono text-electric-cyan tracking-wide font-semibold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 max-w-2xl mx-auto w-full pt-1 font-mono">
                {CAPABILITY_WORLDS[0].metrics.map((m) => (
                  <div
                    key={m.label}
                    className="p-3.5 rounded-xl bg-black/65 border border-white/15 backdrop-blur-2xl text-center hover:border-electric-cyan/50 transition-all duration-300"
                  >
                    <div className="text-[9px] text-white/50 tracking-widest uppercase mb-0.5">
                      {m.label}
                    </div>
                    <div className="text-lg sm:text-xl font-bold text-electric-cyan mb-0.5">
                      {m.value}
                    </div>
                    <div className="text-[9px] text-white/60">{m.desc}</div>
                  </div>
                ))}
              </div>
              ...
              <div className="pt-1">
                <PageTransitionLink
                  ...
                  cursor="explore"
                  className="group inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-electric-cyan text-background font-mono font-bold text-xs tracking-wider hover:shadow-[0_0_35px_rgba(0,212,255,0.8)] transition-all duration-300 hover:scale-105"
                >
          ...
          >
            <div className="relative max-w-4xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-white/[0.04] border border-white/15 text-[9px] sm:text-[10px] font-mono tracking-[0.25em] text-white/70 uppercase">
                <Activity className="w-3 h-3 text-electric-cyan" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 pt-1 text-left">
                {FLAGSHIP_BUILDS.map((build) => (
                  ...
                  >
                    ...
                    <h3 className="text-sm font-heading font-bold text-white group-hover:text-electric-cyan transition-colors mb-1.5">
                      {build.name}
                    </h3>
                    <p className="text-xs font-sans text-white/70 leading-relaxed font-light mb-2.5 line-clamp-2">
                      {build.thesis}
                    </p>
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
                ...
                <PageTransitionLink
                  href="/labs"
                  cursor="explore"
                  className="inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full border border-white/20 hover:border-electric-cyan bg-[#020b18]/80 text-white font-mono text-xs tracking-wider hover:text-electric-cyan transition-all duration-300"
                >
                  <span>ARASS LAB RESEARCH</span>
                  <ArrowUpRight className="w-3.5 h-3.5 text-electric-cyan" />
                </PageTransitionLink>
              </div>
            </div>
          </div>
          ...
          >
            <div className="relative max-w-4xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-white/[0.04] border border-white/15 text-[9px] sm:text-[10px] font-mono tracking-[0.25em] text-white/60 uppercase">
              ...
              <p className="max-w-xl mx-auto text-xs sm:text-sm font-sans text-white/80 leading-relaxed font-light">
              ...
              <div className="pt-2 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
                <PageTransitionLink
                  href="/contact"
                  cursor="explore"
                  className="group inline-flex items-center gap-2 px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-electric-cyan text-background font-mono font-bold text-xs tracking-wider hover:shadow-[0_0_40px_rgba(0,212,255,0.9)] transition-all duration-300 hover:scale-105"
                >
                  <span>START A PROJECT</span>
                  <ArrowUpRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </PageTransitionLink>
