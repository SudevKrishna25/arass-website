...
export const SECONDARY_NAV_ITEMS: NavItem[] = [
  {
    ...
    name: 'VENTURES',
    href: '/ventures',
    title: 'CHAPTER 07 // THE VENTURE FACTORY',
    category: 'secondary',
  ...
  },
  {
    ...
    name: 'LABS',
    href: '/labs',
    title: 'CHAPTER 08 // RESEARCH FRONTIERS',
    category: 'secondary',
    description: 'High-security experimental infrastructure across 6 scientific domains.',
    image: '/images/arass_labs_robotics.jpg',
  },
  {
    id: 'technologies',
    num: '09',
    name: 'CHAPTER 09 // BLUEPRINTS',
    href: '/technologies',
    title: 'CHAPTER 09 // SYSTEMS BLUEPRINTS & HARDWARE',
    category: 'secondary',
  ...
  },
  {
    ...
    name: 'TECH REVIEW',
    href: '/tech-review',
    title: 'CHAPTER 10 // TECHNOLOGY SYSTEMS AUDIT',
    category: 'secondary',
  ...
  },
  {
    ...
    name: 'GLOBAL EVENTS',
    href: '/events',
    title: 'ARASS GLOBAL HACKATHONS & SPRINT PLATFORM',
    category: 'secondary',
    description: 'Participate in global competitions, hackathons, and fellowship assessments.',
    image: '/images/arass_frontier_build_lab.jpg',
  },
  {
    id: 'contact',
    ...
    name: 'ACCESS GATEWAY',
    href: '/contact',
    title: 'CHAPTER 11 // INSTITUTIONAL ACCESS',
    category: 'action',
