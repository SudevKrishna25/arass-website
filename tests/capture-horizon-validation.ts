...
(async () => {
  const outputDir = path.join(process.cwd(), 'screenshots', 'horizon-validation');
  ...
  const desktopCaptures = [
    { filename: '01-section04-final-handoff.png', targetY: 26800 },
    { filename: '02-section05-beginning.png', targetY: 27400 },
    { filename: '03-section05-deep-intelligence.png', targetY: 27900 },
    { filename: '04-section05-synthetic-matter.png', targetY: 28500 },
    { filename: '05-section05-energy-density.png', targetY: 29000 },
    { filename: '06-section05-bio-genesis.png', targetY: 29600 },
    { filename: '07-section05-planetary-harmony.png', targetY: 30100 },
    { filename: '08-section05-final-arass-horizon.png', targetY: 30200 },
  ];
  ...
  const mobileCaptures = [
    { filename: '09-mobile-390x844-beginning.png', targetY: 25800 },
    { filename: '10-mobile-390x844-final.png', targetY: 28400 },
  ];
  ...
  console.log('=== SECTION 05 VISUAL GATE CAPTURE REPORT ===');
  console.log(`Console Errors: ${consoleErrors.length}`);
  if (consoleErrors.length > 0) console.log(consoleErrors);
  console.log('Validation screenshots saved in screenshots/horizon-validation');
})();
